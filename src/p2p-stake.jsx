...
const CONFIG = {
  ...
  accentColor: "#1A9680",     // PhonePe-inspired purple
        ...
        {showUtrHelp && (
          <div style={{ ...$.utrHelp, animation: "fadeUp .2s ease" }}>
            ...
            <div style={$.mockWrap}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, padding: "4px 6px", margin: "2px -6px", background: "#9FE1CB", borderRadius: 6 }}>
...
const $ = {
  wrapper: {
    minHeight: "100vh",
    background: "linear-gradient(170deg, #e1f5ee 0%, #f8f6fc 40%, #fff 100%)",
  ...
  amtBadge: {
    ...
    color: accent, background: "#e1f5ee", padding: "3px 10px", borderRadius: 20, border: "1px solid #9FE1CB",
  },

  // Timer
  timerWrap: { margin: "0 18px 16px", padding: "8px 12px", borderRadius: 10, border: "1px solid #e2e8f0", background: "#f0fdf8" },
  ...
  copyBtn: {
    ...
    background: "#e1f5ee", border: "1px solid #9FE1CB", fontSize: 11, fontWeight: 700,
  ...
  detectBanner: {
    ...
    background: "#e1f5ee", borderRadius: 10, marginBottom: 14, border: "1px solid #9FE1CB",
  },
  ...
  input: {
    ...
    transition: ".2s ease", letterSpacing: ".08em", background: "#f0fdf8",
  },
  ...
  utrHelp: {
    ...
    border: "1px solid #9FE1CB", marginBottom: 14, display: "flex", flexDirection: "column", gap: 8,
  },
  howRow: { display: "flex", gap: 8, alignItems: "flex-start", fontSize: 12, color: "#475569", lineHeight: 1.5 },
  howNum: {
    minWidth: 18, height: 18, borderRadius: "50%", background: "#9FE1CB", color: accent,
  ...
  btnPrimary: {
    ...
    background: `linear-gradient(135deg, ${accent}, #0F6E56)`,
