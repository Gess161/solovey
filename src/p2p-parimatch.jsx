...
const CONFIG = {
  ...
  accentColor: "#C89200",     // PhonePe-inspired purple
        ...
        {showUtrHelp && (
          <div style={{ ...$.utrHelp, animation: "fadeUp .2s ease" }}>
            ...
            <div style={$.mockWrap}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, padding: "4px 6px", margin: "2px -6px", background: "#FAC775", borderRadius: 6 }}>
...
const $ = {
  wrapper: {
    minHeight: "100vh",
    background: "linear-gradient(170deg, #FAEEDA 0%, #f8f6fc 40%, #fff 100%)",
  ...
  amtBadge: {
    ...
    color: accent, background: "#FAEEDA", padding: "3px 10px", borderRadius: 20, border: "1px solid #FAC775",
  },

  // Timer
  timerWrap: { margin: "0 18px 16px", padding: "8px 12px", borderRadius: 10, border: "1px solid #e2e8f0", background: "#FFFBF0" },
  ...
  copyBtn: {
    ...
    background: "#FAEEDA", border: "1px solid #FAC775", fontSize: 11, fontWeight: 700,
  ...
  detectBanner: {
    ...
    background: "#FAEEDA", borderRadius: 10, marginBottom: 14, border: "1px solid #FAC775",
  },
  ...
  input: {
    ...
    transition: ".2s ease", letterSpacing: ".08em", background: "#FFFBF0",
  },
  ...
  utrHelp: {
    ...
    border: "1px solid #FAC775", marginBottom: 14, display: "flex", flexDirection: "column", gap: 8,
  },
  howRow: { display: "flex", gap: 8, alignItems: "flex-start", fontSize: 12, color: "#475569", lineHeight: 1.5 },
  howNum: {
    minWidth: 18, height: 18, borderRadius: "50%", background: "#FAC775", color: accent,
  ...
  btnPrimary: {
    ...
    background: `linear-gradient(135deg, ${accent}, #996E00)`,
