...
const CONFIG = {
  ...
  accentColor: "#1985E0",     // PhonePe-inspired purple
        ...
        {showUtrHelp && (
          <div style={{ ...$.utrHelp, animation: "fadeUp .2s ease" }}>
            ...
            <div style={$.mockWrap}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, padding: "4px 6px", margin: "2px -6px", background: "#b5d4f4", borderRadius: 6 }}>
...
const $ = {
  wrapper: {
    minHeight: "100vh",
    background: "linear-gradient(170deg, #e6f1fb 0%, #f8f6fc 40%, #fff 100%)",
  ...
  amtBadge: {
    ...
    color: accent, background: "#e6f1fb", padding: "3px 10px", borderRadius: 20, border: "1px solid #b5d4f4",
  },

  // Timer
  timerWrap: { margin: "0 18px 16px", padding: "8px 12px", borderRadius: 10, border: "1px solid #e2e8f0", background: "#f0f7ff" },
  ...
  copyBtn: {
    ...
    background: "#e6f1fb", border: "1px solid #b5d4f4", fontSize: 11, fontWeight: 700,
  ...
  detectBanner: {
    ...
    background: "#e6f1fb", borderRadius: 10, marginBottom: 14, border: "1px solid #b5d4f4",
  },
  ...
  input: {
    ...
    transition: ".2s ease", letterSpacing: ".08em", background: "#f0f7ff",
  },
  ...
  utrHelp: {
    padding: "12px 14px", background: "#e6f1fb", borderRadius: 10,
    border: "1px solid #b5d4f4", marginBottom: 14, display: "flex", flexDirection: "column", gap: 8,
  },
  howRow: { display: "flex", gap: 8, alignItems: "flex-start", fontSize: 12, color: "#475569", lineHeight: 1.5 },
  howNum: {
    minWidth: 18, height: 18, borderRadius: "50%", background: "#b5d4f4", color: accent,
  ...
  btnPrimary: {
    ...
    background: `linear-gradient(135deg, ${accent}, #0D5BA0)`,
